...
<head>
 ...
 <c:if test="${!empty resultMap}">
     <c:if test="${resultMap.get('succ')==0}">
       <script>alert("注册失败，系统繁忙");location.href='/cakeTest01/register.jsp'</script>
     </c:if>
 </c:if>
      ...
      <div class="container-fluid" style="font-size:1.6em; padding-top:10px; padding-left:70px; ">
        ...
        <div class="collapse navbar-collapse navbar-collapse-example" >
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<%=request.getContextPath()%>/register.jsp">注册</a></li>
            <li ><a href="<%=request.getContextPath()%>/login.jsp">登录</a></li>
          </ul>
          
          <!--右侧购物车 导航条里 图标里-->
          <ul class="nav navbar-nav navbar-right" style="padding-right:60px;">
              <li><a href="your/nice/url"><i class="icon icon-shopping-cart icon-2x"></a></i></li>
          </ul>
    ...
    <div class="panel">
      ...
      <div class="panel-body panel-center">
        ...
        <div class="row">
            <div class="col-md-6">
                <!--输入组 嵌套form表单-->
              <form action="/cakeTest01/UserLoginByMysql?action=register" method="post">
                ...
                <div class="input-group">
                  ...
                  <input type="email" class="form-control" placeholder="请输入邮箱" id="mail" name="mail" required>
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" placeholder="请输入收货人名字" id="receiveName" name="receiveName" required>
                </div>
                <div style="margin-top:20px;"></div><!--上下隔开-->
                <div class="input-group">
                  <span class="input-group-addon">收获人电话&nbsp;<font color="red">*</font></span>
                  <input type="text" class="form-control" placeholder="请输入收获人联系方式" id="receivePhone" name="receivePhone" required>
                </div>
                <div style="margin-top:20px;"></div><!--上下隔开-->
                <div class="input-group">
                  <span class="input-group-addon">收获地址&nbsp;<font color="red">*</font></span>
                  <input type="text" class="form-control" placeholder="请输入收获人地址" id="receiveAddress" name="receiveAddress" required>
                </div>
                <div style="margin-top:20px;"></div><!--上下隔开-->
                <div class="input-group" style="padding-left:196px;">
                  
                  <button class="btn btn-success " type="submit" id="regist">注册</button>
                </div>
                </form>
            </div>
        </div>
